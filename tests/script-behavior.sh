...
assert_contains "${TEST_STATE_DIR}/patches/common.yaml" "kubePrism:"
assert_contains "${TEST_STATE_DIR}/patches/common.yaml" "enabled: true"
assert_contains "${TEST_STATE_DIR}/patches/common.yaml" "port: 7445"
assert_contains "${TEST_STATE_DIR}/patches/common.yaml" "proxy:"
assert_contains "${TEST_STATE_DIR}/patches/common.yaml" "disabled: true"
...
assert_file "${TEST_STATE_DIR}/cilium/cilium-bootstrap.yaml"
assert_contains "${TEST_STATE_DIR}/cilium/cilium-bootstrap.yaml" "kind: DaemonSet"
assert_contains "${TEST_STATE_DIR}/cilium/values.yaml" "kubeProxyReplacement: true"
assert_contains "${TEST_STATE_DIR}/cilium/values.yaml" "k8sServiceHost: localhost"
assert_contains "${TEST_STATE_DIR}/cilium/values.yaml" "k8sServicePort: 7445"
